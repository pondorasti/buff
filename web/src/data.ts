...
export const loads: LoadGroup[] = [
  { title: 'Barbell compounds — Freedom Rack', rows: [
    ...
    { name: 'Overhead Press',    trains: 'Shoulders',      start: '20 kg / 44 lb (bar)', target: '30 kg / 66 lb', ex: 'overhead-press' },
  ...
  { title: 'Machine & cable accessories', rows: [
    ...
    { name: 'Incline DB Press', trains: 'Upper chest · per DB', start: '7 kg / 15 lb', target: '11 kg / 25 lb (DB cap)', ex: 'incline-db-press' },
